      ...
      <div className="relative z-10 mx-auto grid max-w-7xl items-center gap-8 px-5 pb-16 pt-2 sm:gap-10 sm:px-8 sm:pb-24 sm:pt-6 md:grid-cols-[1fr,1.05fr] md:gap-12 md:pb-32 md:pt-10">
        <div>
          <img
            src={wordmark}
            alt="Yo Dawg"
            className="relative left-1/2 h-auto w-screen max-w-none -translate-x-1/2 drop-shadow-[0_14px_28px_hsl(220_50%_4%/0.35)] rounded-sm opacity-100 border-0 text-lg sm:left-0 sm:w-full sm:max-w-[42rem] sm:translate-x-0"
            loading="eager"
          />
